...
public class DSDateTime
{
	...
	{
		int secondSep = (int)(DSDateTime.Now - time_monday030).TotalSeconds;
		return (int)(secondSep / DSDateTime.weekly_seconds);
	}
	...
	{
		return (int)(DSDateTime.Now - time_begin).TotalSeconds;
	}
	public static long SecondsFrom19700101()
	{
		return (long)(DateTime.Now - new System.DateTime(1970, 1, 1, 8, 0, 0)).TotalMilliseconds;
	}
